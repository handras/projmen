...
%------------------------------------------------------------
%
\documentclass[a4paper,12pt,leqno, notitlepage]{report}%
...
Ezután áttekintem a projektmenedzsment szereplőit és folyamatát. Célom bemutatni, hogy a munkahelyemen hogyan került bevezetésre az agilis módszertan és milyen kapcsolat van a projekt menedzsmerei és az agilis szoftver\-fejlesztés szereplői között.
\end{abstract}


\chapter{Szoftverfejlesztési módszerek}
